...
features = [
    'CA_total', 'panier_moyen', 'nb_total_produits', 'nb_moyen_produits',
    'total_discount', 'Average_Purchase_Frequency_Per_Month', 'Historical_CLV_Revenue',
    'pays', 'type_loyalty_card', 'pression_commerciale',
    'secteur_top_1', 'secteur_top_2', 'favorite_store', 'nb_DRI', 'nb_campagnes_recues'
]

# --- IDENTIFICATION DES CATEGORIELLES ET NUMERIQUES ---
...
for persona_id in range(N_PERSONAS):
    ...
    profile = {
        ...
        'secteur_secondaire': df_persona['secteur_top_3'].mode()[0] if df_persona['secteur_top_3'].notna().any() else 'N/A',
